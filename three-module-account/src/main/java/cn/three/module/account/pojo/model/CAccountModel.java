...
import cn.three.module.account.pojo.Company;
import cn.three.module.account.pojo.Staff;
 ...
 */
public class CAccountModel extends BaseModel{
    ...
    private String roleID;//当前角色currentrole
    ...
    //启用的用户组信息(组互斥)
    private String groupId;//当前组currentgroup
